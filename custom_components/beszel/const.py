...
ATTR_DISK_READ_PS_MB = "dr" # Re-added
ATTR_DISK_WRITE_PS_MB = "dw" # Re-added
ATTR_NET_SENT_PS_MB = "ns" # Re-added
ATTR_NET_RECV_PS_MB = "nr" # Re-added
ATTR_TEMPERATURES = "t"
ATTR_EXTRA_FS = "efs"
ATTR_GPU_DATA = "g"
...
ATTR_FS_DISK_READ_PS_MB = "r" # Re-added
ATTR_FS_DISK_WRITE_PS_MB = "w" # Re-added
