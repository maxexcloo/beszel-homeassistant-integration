...
from .const import (
    DOMAIN,
    ATTR_HOSTNAME, ATTR_KERNEL_VERSION, ATTR_CPU_PERCENT_INFO, ATTR_THREADS, ATTR_CORES,
    ...
    ATTR_SWAP_USED_GB, ATTR_DISK_TOTAL_GB, ATTR_DISK_USED_GB, ATTR_DISK_PERCENT,
    ...
    ATTR_GPU_POWER_W,
    ATTR_FS_DISK_TOTAL_GB, ATTR_FS_DISK_USED_GB, ATTR_FS_DISK_READ_PS_MB,
